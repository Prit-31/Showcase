const CONTACT_ITEMS = [
  { icon: "📞", label: "Phone", val: "+91 7069640297" },
  { icon: "📧", label: "Email", val: "gujaratip31+portfolio@gmail.com" },
  { icon: "📍", label: "Location", val: "Mumbai, Maharashtra, India" },
];


export default function Contact({ form, setForm, submitting, handleSubmit }) {
  return (
    <section id="contact" className="section contact-section">
      <div className="sec-label">07 — CONTACT</div>
      <div className="sec-title">Establish <span>Connection</span></div>
      ...
      <div className="contact-grid">
        ...
        <form className="contact-form" onSubmit={handleSubmit}>
          <div className="form-titlebar">
            <div className="t-dot" style={{ background: "#f85149", borderRadius: "50%", width: 10, height: 10 }} />
            <div className="t-dot" style={{ background: "#e3b341", borderRadius: "50%", width: 10, height: 10 }} />
            <div className="t-dot" style={{ background: "#3fb950", borderRadius: "50%", width: 10, height: 10 }} />
            <span style={{ marginLeft: 8 }}>send_message.sh</span>
          </div>
